...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayCartItems() {
        ...
        if (cart.length === 0) {
            ...
            if (cartActionsDiv) {
                 cartActionsDiv.innerHTML = `<a href="../../jsp/shop.jsp" class="btn btn-primary shop-now-link-btn">Shop Now</a>`;
    ...
    function displayProductDetail(productId) {
        ...
        if (!product) {
            ...
            `;
             ...
             productDetailContainer.querySelector('.product-detail-price').textContent = `$${product.price.toFixed(2)}${product.unit || ''}`;
